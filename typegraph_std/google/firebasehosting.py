...
def import_firebasehosting():
    firebasehosting = HTTPRuntime("https://firebasehosting.googleapis.com/")

    renames = {
        "ErrorResponse": "_firebasehosting_1_ErrorResponse",
        "ListOperationsResponseIn": "_firebasehosting_2_ListOperationsResponseIn",
        "ListOperationsResponseOut": "_firebasehosting_3_ListOperationsResponseOut",
